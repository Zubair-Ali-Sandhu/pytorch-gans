...
st.sidebar.title("GenAI Assignment 03")
st.sidebar.markdown("FAST NUCES | AI4009 | Spring 2026")
st.sidebar.markdown("Group: 22F-3845 & 22F-3360")
st.sidebar.divider()
...
if page == "Home":
    st.title("Generative AI Assignment 03 - Combined Demo")
    st.markdown("Use the sidebar to open Q1, Q2, and Q3 in one app.")
    st.divider()
...
st.divider()
st.caption(
    "Built with Streamlit | Generative AI Assignment 03 | FAST NUCES Spring 2026 | 22F-3845 & 22F-3360"
)